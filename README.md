...
The solution transforms raw operational data into a **decision-support dashboard**, enabling businesses to improve efficiency, reduce risk, and optimize inventory strategies.  
...
- **Microsoft Excel**  
  ...
  - Advanced formulas (XLOOKUP, IF, KPI metrics)  
  - Data modeling (relational structure using lookup tables)  
...
✔ Simulates relational database design  
...
- ⚠️ Stockout vs availability analysis  
...
- Evaluate supplier reliability and reduce dependency on underperforming vendors  
